...
export function Sidebar() {
  ...
  return (
    <aside className="w-[219px] pl-[24px] min-h-screen flex flex-col items-center py-6 gap-[32px] bg-transparent">
      
      {/* 1. Botão Nova Ficha */}
      <button 
        className="w-[169px] h-[39px] bg-[#A9E2F2] rounded-[18.5px] flex items-center justify-start px-4 gap-3 transition-all duration-200 shadow-sm hover:bg-[#8ecce0]"
      >
