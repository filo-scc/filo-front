        ...
        <div className="p-6 pt-0">
            ...
            <div className="bg-white p-8 rounded-[24px] shadow-sm min-h-[400px]">
                ...
                <p className="text-[#898C8F]">
                    ...
                    doloremque aspernatur laborum repellat iste nesciunt a, molestias deleniti sunt
                    nulla ullam expedita ad quia alias porro. Reprehenderit, error culpa. Lorem
                    ipsum dolor sit amet consectetur adipisicing elit. Accusantium eaque, doloremque
                    aspernatur laborum repellat iste nesciunt a, molestias deleniti sunt nulla ullam
                    expedita ad quia alias porro. Reprehenderit, error culpa.
                </p>
            </div>
        </div>
    );
