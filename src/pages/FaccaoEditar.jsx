                ...
                <form onSubmit={handleSubmit} className="space-y-8 w-full px-6">
                                    ...
                                    >
                                        {["PIX", "TED"].map((opcao) => (
                                            ...
                                            >
                                                ...
                                                {opcao === "TED" ? "TED (Transferência)" : opcao}
                                            </button>
                                        ))}
                                    </div>
                                </div>
                    ...
                    <div className="flex justify-end pt-4">
                        <button
                            type="submit"
                            disabled={saving}
                            className="bg-[#a9e2f2] hover:bg-[#A2DCED] text-[#4696ad] px-8 py-3 rounded-full text-sm font-medium transition-colors disabled:opacity-50 shadow-sm"
                        >
