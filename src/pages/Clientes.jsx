                ...
                {clientes.map((cliente, index) => (
                  ...
                  >
                    ...
                    <td className="py-5 px-4">
                      <span
                        className={`px-8 py-1.5 rounded-full text-xs font-Outfit font-light text-white ${cliente.status ? "bg-[#B4D64E]" : "bg-[#D9D9D9] text-[#414040]"}`}
                      >
